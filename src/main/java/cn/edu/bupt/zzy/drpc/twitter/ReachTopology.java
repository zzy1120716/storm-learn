package cn.edu.bupt.zzy.drpc.twitter;
 ...
 *
 * 程序创建一个topology，来实时、并行计算一个Twitter中包含的URL的覆盖量。
 *
 * <p/>
 ...
 * records.
 *
 * 覆盖量：指Twitter中的URL能让多少不同的人看到，需要两个数据集，一个是推了某个链接的所有人的集合，一个是每个人的关注者的集合。
 * 由于会有某个人的两个好友都推了这个URL，所以需要对结果集进行去重。
 *
 * <p/>
...
public class ReachTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args == null || args.length == 0) {
            ...
            // Output:
            // Reach of foo.com/blog/1: 16
            // Reach of engineering.twitter.com/blog/5: 14
            // Reach of notaurl.com: 0
